...
\begin{frame}{Applications to CEA: Models}
	\onslide<2->{
	\begin{equation*}
		f(x,u,d) = \color{pgreen}p_i(x,u,d)\color{black} + 
			\color{porange}g_j(x,u,d)\color{black}
	\end{equation*}
	}
	...
	\begin{columns}
		\begin{column}{0.45\linewidth}
			\begin{block}{Plant model: $\color{pgreen}p_i(x,u,d)$}
				\begin{itemize}
		...
		\end{column}
		\begin{column}{0.45\linewidth}
			\begin{block}{Greenhouse model: $\color{porange}g_j(x,u,d)$}
				\begin{itemize}
					\item Low complexity
...
%		{$g_j(\cdot)$};
		...
		\node[color=pgreen] at (1,2.6) {$p_i(x,u,d)$};
		}
	\end{tikzpicture}
\end{frame}
...
\begin{frame}{Optimal control}
	\begin{tikzpicture}[circle dotted/.style={dash pattern=on .05mm off 6mm,
		...
		\begin{equation*}
			...
			\underbrace{\ell(x_k,u_k)}_{\textnormal{Stage Cost}} \quad 
		...
		\begin{column}{0.45\linewidth}
			\begin{block}{Model predictive control (MPC)}
				\begin{itemize}
					...
					\item Better for:
					\begin{itemize}
						\item Shorter time-scales
						\item Large state/input 
						dimension
					\end{itemize}
				\end{itemize}
			\end{block}
		...
		\begin{column}{0.45\linewidth}
			\begin{block}{Reinforcement learning (RL)}
				\begin{itemize}
					...
					\item Better for:
					\begin{itemize}
						\item Longer time-scales
						\item Small state/input dimension
					\end{itemize} 
				\end{itemize}
			\end{block}
		\end{column}
